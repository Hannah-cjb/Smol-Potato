# DEPLOY.md — Get Smol Potato AI online (free, no card)
...
1. Go to **https://discord.com/developers/applications** and click **New Application**.
   Name it **Smol Potato AI** (this shows as the bot's name). Click **Create**.
...
5. You should now see **Smol Potato AI** appear in your server's member list.
...
2. Click **+** → **New repository** → name it `smol-potato` → make it **Private** →
...
3. In a terminal on your PC, run these (replacing `YOUR_USERNAME`):
   ...
   git init
   git add .
   git commit -m "Smol Potato AI Discord bot"
   git branch -M main
   git remote add origin https://github.com/YOUR_USERNAME/smol-potato.git
...
3. Connect your GitHub account → choose the **smol-potato** repo.
4. Settings:
   - **Name**: `smol-potato` (this becomes `https://smol-potato.onrender.com`)
...
6. **Second deployment:** after it's live, note the URL
   (`https://smol-potato.onrender.com`). Add one more env var:
   - `PUBLIC_URL` = `https://smol-potato.onrender.com`
   - Save → redeploys.
7. Watch the **Logs** tab: you should see `Logged in as Smol Potato AI#1234` and
...
3. **Check URL**: `https://smol-potato.onrender.com/ping`
...
- `@Smol Potato AI` hello
- Reply to one of its messages to continue the conversation
- `/ask what's your favorite kind of potato?`
- DM the bot directly
