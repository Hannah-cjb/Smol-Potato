...
## Features
- **@mention** Smol Potato in a channel and it replies.
...
| `persona.md` | Smol Potato's personality prompt (edit freely, it reloads on restart) |
